...
ALTER TABLE comments_under_order
    ADD CONSTRAINT comments_under_order_needlework_order
...
ALTER TABLE comments_under_order
    ADD CONSTRAINT comments_under_order_user
        FOREIGN KEY (user_id)
            REFERENCES "user" (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE image
    ADD CONSTRAINT image_user_order
...
ALTER TABLE tailoring_order
    ADD CONSTRAINT needlework_order_color
...
ALTER TABLE tailoring_order
    ADD CONSTRAINT needlework_order_material
...
ALTER TABLE tailoring_order
    ADD CONSTRAINT needlework_order_user
        FOREIGN KEY (user_id)
            REFERENCES "user" (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE part_size
    ADD CONSTRAINT part_size_user_order
        FOREIGN KEY (user_order_id)
            REFERENCES tailoring_order (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE template_orders
    ADD CONSTRAINT template_orders_tailoring_templates
...
ALTER TABLE template_orders
    ADD CONSTRAINT template_orders_user_order
        FOREIGN KEY (user_order_id)
            REFERENCES tailoring_order (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
